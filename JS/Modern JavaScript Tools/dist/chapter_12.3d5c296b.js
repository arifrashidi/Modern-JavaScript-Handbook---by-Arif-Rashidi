...
})({"cUGb8":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8698c7463d5c296b";
"use strict";
...
},{}],"9RKfc":[function(require,module,exports) {
...
//- Example 1 
var _exportModuleJs = require("./export_module.js");
var _exportModuleJsDefault = parcelHelpers.interopDefault(_exportModuleJs);
// -----------------
...
//- Example 1: 
var _lodash = require("lodash"); //⭐ shorter, more concise import paths.
...
//- Example 1 
console.log((0, _exportModuleJs.grocery_store_name));
//- Example 2 
(0, _exportModuleJs.add_cart)("bread", 5) // call function that from export module
;
//- Example 3 
const fruit_quantities = function(apples_num, oranges_num, watermelon_num) {
    console.log(`There are ${apples_num} apples, ${oranges_num} oranges and ${watermelon_num} watermelon`);
};
fruit_quantities((0, _exportModuleJs.apples), (0, _exportModuleJs.oranges), (0, _exportModuleJs.watermelon));
//🔗  The following examples show all export modules variable can be used 
//- Example 1
console.log(_exportModuleJs.grocery_store_profit);
//🔗  The following examples show the default export modules variable can be used 
//- Example 1
console.log((0, _exportModuleJsDefault.default)[0]);
//* --------------------------------------------------------------------------
// 🧡 VSCode Terminal 
...
const all_animals = (0, _lodashDefault.default).concat(capybaras, oyen);
console.log(all_animals); //* --------------------------------------------------------------------------

},{"./export_module.js":"2g5bn","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2g5bn":[function(require,module,exports) {
//* --------------------------------------------------------------------------
// • 🧡: Main topic 
// • 📝: Notes 
// • 🔸: Subtopics 
...
parcelHelpers.export(exports, "grocery_store_name", ()=>grocery_store_name);
parcelHelpers.export(exports, "grocery_store_profit", ()=>grocery_store_profit);
parcelHelpers.export(exports, "add_cart", ()=>add_cart);
parcelHelpers.export(exports, "apples", ()=>apples);
parcelHelpers.export(exports, "oranges", ()=>oranges);
parcelHelpers.export(exports, "watermelon", ()=>watermelon);
...
const grocery_store_name = "Lotus Supermarket";
const grocery_store_profit = `RM ${1200000}`;
const add_cart = function(product, quantity) {
...
},{}]},["cUGb8","9RKfc"], "9RKfc", "parcelRequire068a")

//# sourceMappingURL=chapter_12.3d5c296b.js.map
